...
CREATE TABLE `Voiture` (
  ...
  CONSTRAINT `Utilisateur_VoitureFK` FOREIGN KEY (`UtilisateurID`) REFERENCES `Utilisateur` (`UtilisateurID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `Voiture` VALUES (1,'BMV i320',4,1),(2,'BMW i720',4,1);
