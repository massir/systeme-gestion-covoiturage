...
CREATE TABLE `Inscription` (
  ...
  KEY `AnnonceFK_idx` (`AnnonceID`),
  KEY `Utilisateur_asso_AnnonceFK_idx` (`UtilisateurID`),
  CONSTRAINT `AnnonceFK` FOREIGN KEY (`AnnonceID`) REFERENCES `Annonce` (`AnnonceID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `Utilisateur_asso_AnnonceFK` FOREIGN KEY (`UtilisateurID`) REFERENCES `Utilisateur` (`UtilisateurID`) ON DELETE NO ACTION ON UPDATE NO ACTION
